...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, CryptMessage> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CryptMessage> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, CryptMessage> factory = new ConcurrentKafkaListenerContainerFactory<>();
